...
function! a#AlternateFile(splitWindow, ...)
...
function! a#AlternateOpenFileUnderCursor(splitWindow,...)
...
" Returns  : nothing
" Author   : Michael Sharpe (feline@irendi.com) www.irendi.com
function! a#AlternateOpenNextFile(bang)
   let cursorFile = ""
